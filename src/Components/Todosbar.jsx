    ...
    return(
        ...
        <div className={"todos-bar"} >
            ...
            <label className="todos-bar_container">
                <input data-id={props.uniqueID} onChange={ToggleCheckbox}  type="checkbox"  checked={props.Status==="Completed"}/>
            ...
            <div    title={"delete"} className={"Todos-bar_delete"}>
                <img src={deleteIcon} alt={"delete"} data-id={props.uniqueID} onClick={onClickDeleteTodos}  className={"Todos-bar_deleteIcon"} />
